...
if(!isset($_GET['product']) && strlen(trim($_GET['product']))!=0 )
{
	header('Refresh:1;url='.$url_root.'index.php');
...
<!--Header Ends -->	
	<div id="Add_products">	
		  ...
		  <?php 
				...
				?>
				<h2>Edit Photos For The Product </h2>
				<a href="index.php"> << Home </a>
		  </div>
		  <div class="clear"></div>
			<div class="add_photo_information">
			<?php echo "<div class='col-lg-4'><div class='add_head'><span>Product Title :</span> $title </div> </div>
			<div class='col-lg-4'><div class='add_head'><span>Category :</span> $category </div> </div>
			<div class='col-lg-4'><div class='add_head'><span>Uploaded On : </span> ".get_timeago(strtotime($upload_on)) ." </div> 
			</div>";?> 
			</div> 		
