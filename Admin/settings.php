		...
		<div class="Log_mateial_top"></div>
			<div class="Log_mateial_main">
				<div class="login-body">
					...
					<h3 class="w3ls-title w3ls-title1">Edit Username And Password</h3>  
					<form action="" method="post" id="form1">
						<input type="text" class="user"  placeholder="Username" id="username" value="<?php echo $_SESSION['session_admin_web']['login_userName'] ;?>" required>
						<input type="password"  class="lock" placeholder="Old Password" id="old_password" required>
						<span id="oldPwdError" class="error"></span> 
						<input type="password"  class="lock" placeholder="New Password" id="new_password" required>
