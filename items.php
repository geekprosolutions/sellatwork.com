...
if(@file_get_contents("backpages/category_items.json"))
{
	$json=file_get_contents("backpages/category_items.json");
	...
	<div id="items">  
		 	<div class="Prod_wrape" id="prod_media">
			  	...
			  	<?php 
					...
					{
						echo '<div class="info512" style="width:100%; min-height:420px;"><h1 class="result_found">'.$array['msg'].'</h1> </div>';
					}
							...
							<div class="item_wrpe">
									<?php 
											...
											else
											{
												...
												for($i=0;$i<count($array[0]['product_list']);$i++)
												{
														...
														<div class="thumbnail">	
															...
															<div class="caption2">
																<div class="prod_h4">
																	<a href="ViewAd/'.$array[0]['product_list'][$i]['product_id'].'">
																	<h4>
																		'.$array[0]['product_list'][$i]['product_title'] .'</h4></a>
																</div>
																		...
																		if(isset($_SESSION['session_web']['valid']) && $_SESSION['session_web']['valid']==true)
																		{
																			if(isset($_SESSION['session_web']['login_userVerified']) && $_SESSION['session_web']['login_userVerified']=="Verified")
																			{
																				if(isset($_SESSION['session_web']['login_userCompanyVerified']) && $_SESSION['session_web']['login_userCompanyVerified']=="Verified")
																				{
																					...
																					{
																						echo'<input type="hidden" value="'.$array[0]['product_list'][$i]['product_user_id'] .'-'.$array[0]['product_list'][$i]['product_id'].'" >
