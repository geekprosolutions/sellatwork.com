...
include "backpages/my_productList.php";
?>
<!DOCTYPE html>
<html lang="en">
<head>
									...
									echo '<div class="inbox_wrape">										 
												...
												<div class="col-lg-4 col-md-5 col-sm-12 col-xs-12 col-xs-offset-0">
													<div class="right" style="padding-top: 1em;">
														<button class="deleteItem  price2"  data-placement="top" data-toggle="tooltip" title="Delete Product"  onclick="deleteItem('.$json[0][$i]['product_id'].')">
															<i class="fa fa-trash" aria-hidden="true"></i>
														</button>
														<a href="Edit/'.$json[0][$i]['product_id'].'" ><button class="deleteItem  price2"  data-placement="top" data-toggle="tooltip" title="Edit Product"  >
