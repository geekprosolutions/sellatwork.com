...
if ($success) 
{
	...
	$reg_email=$user->emailAddress;
	$reg_company=$user->positions->values[0]->company->name;
	//$user_id = $db->checkUser($user);
	$_SESSION['loggedin_user_id'] = $_SESSION['session_web']['login_userId'];
	$_SESSION['loggedin_reg_email'] = $_SESSION['session_web']['login_userEmail'];
	$_SESSION['linked_in_email'] = $reg_email;
	$_SESSION['linked_in_company'] = $reg_company;
	$_SESSION['user'] = $user;
