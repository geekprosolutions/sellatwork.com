...
<html lang="en">
<head>
<title>Verify Company Account </title>
...
<!--Header Ends -->	
  ...
  <div class="login-page">
		...
		<?php 
			...
			$sql_query=mysqli_query($conn,"select * from users where user_id=$verification_id and company_verification_code='$verification_code' ");
			...
			if($sql_rows==1) // If Account Is Activated
			{
				...
				// Update User table
				$login_status=1;
				$sql_query2=mysqli_query($conn,"update users set company_verified='Verified' where user_id=$verification_id ");
