...
<!--Header Ends -->	
  ...
  <div class="login-page">
		...
		<?php 
			...
			$sql_query=mysqli_query($conn,"select * from users where user_id=$verification_id and account_verification_code='$verification_code' ");
			...
			if($sql_rows==1) // If Account Is Activated
			{
				...
				// Update User table
				$login_status=1;
				$sql_query2=mysqli_query($conn,"update users set account_verified='Verified',last_login_on='$current_date_time',login_status=$login_status where user_id=$verification_id ");
				...
				$_SESSION['session_web']['login_userVerified']="Verified";
